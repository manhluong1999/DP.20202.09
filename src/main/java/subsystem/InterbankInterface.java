...
public interface InterbankInterface {
	 ...
	 */
	public abstract PaymentTransaction payOrder(ICard card, int amount, String contents)
	 ...
	 *                               something goes wrong
	 */
	public abstract PaymentTransaction refund(ICard card, int amount, String contents)
			throws PaymentException, UnrecognizedException;
